...
public class UnexpectedErrorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            //On va écrire le contenu du message dans cette balise "h1", pour distinger, on ajoute une parenthèse
            out.println("<h1>Une erreur inexplicable est survenue, l'opération est annulée !(provient de la Servlet)</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
